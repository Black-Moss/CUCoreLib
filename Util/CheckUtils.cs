...
namespace CUCoreLib.Util
{
    public static class CheckUtils
    {
        ...
        public static bool IsModdedItem(string itemId)
        {
            ...
            return normalizedId.StartsWith("glassworks.", System.StringComparison.OrdinalIgnoreCase) ||
                   normalizedId.StartsWith("cucorelib.", System.StringComparison.OrdinalIgnoreCase);
        }
    }
}